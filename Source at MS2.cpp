...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "My 3D World", NULL, NULL);
	if (window == NULL)
	{
	...
	float vertices[] = {
		//Setting indicies and normals for drawing triangles 
	...
	unsigned int VBO2, VAO2;//table surface
	unsigned int VBO3, VAO3;// ball
	...
	//buffer for base alcohol bottle
	...
	//buffer for table surface
	glGenVertexArrays(1, &VAO2);
	glGenBuffers(1, &VBO2);
	glBindVertexArray(VAO2);
	glBindBuffer(GL_ARRAY_BUFFER, VBO2);

	//buffer for the ball object
	glGenVertexArrays(1, &VAO3);
	glGenBuffers(1, &VBO3);
	glBindVertexArray(VAO3);
	glBindBuffer(GL_ARRAY_BUFFER, VBO3);

	//buffer for contact lens container
	glGenVertexArrays(1, &VAO4);
	glGenBuffers(1, &VBO4);
	glBindVertexArray(VAO4);
	glBindBuffer(GL_ARRAY_BUFFER, VBO4);

	//buffer for tin container
	glGenVertexArrays(1, &VAO5);
	glGenBuffers(1, &VBO5);
	glBindVertexArray(VAO5);
	glBindBuffer(GL_ARRAY_BUFFER, VBO5);

	//buffer for top of alcohol bottle
	glGenVertexArrays(1, &VAO6);
	glGenBuffers(1, &VBO6);
	glBindVertexArray(VAO6);
	glBindBuffer(GL_ARRAY_BUFFER, VBO6);

	//buffer for alcohol cap
	glGenVertexArrays(1, &VAO7);
	glGenBuffers(1, &VBO7);
	glBindVertexArray(VAO7);
	glBindBuffer(GL_ARRAY_BUFFER, VBO7);

	//buffer for solution cap texture
	glGenVertexArrays(1, &VAO8);
	glGenBuffers(1, &VBO8);
	glBindVertexArray(VAO8);
	glBindBuffer(GL_ARRAY_BUFFER, VBO8);

	//buffer for solution cap top
	...
	//setting up textures for all objects
	...
	// texture 2 - Texture for sphere, ball object. 
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//to change projection press P key
		glm::mat4 projection;
		if (orthographic) {
		...
		//This shape is used as the plane - tex 3
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, texture3);
		glBindVertexArray(VAO2);
		model = glm::mat4(1.0f); 		
